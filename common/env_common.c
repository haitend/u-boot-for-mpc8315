...
/******修改bootargs for mpc8315erdb only jffs2 **********************/
/********mtdblock3 就是文件系统存放的位置,根据下载的位置决定*********/
	"bootargs="  "root=/dev/mtdblock3 rw rootfstype=jffs2 console=ttyS0,115200 "  "\0"
/*********end *******************************************/
...
/*****等待时间改成2秒 *******************/
	...
	"bootcmd="    "bootm fe200000 - fe100000"       "\0"
/*********end ***************************/
/*
