...
#define CONFIG_SYS_NAND_U_BOOT_SIZE	(512 << 10)	/* Size of RAM U-Boot image 384==>512*/
...
#define CONFIG_BOOTDELAY 2	/* -1 disables auto-boot modify 6==>2 */
